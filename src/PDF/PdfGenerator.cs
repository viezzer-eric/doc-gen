    ...
    private static string WrapHtmlWithStyles(string bodyHtml)
    {
        ...
        string template = """
            ...
            <head>
                <meta charset="UTF-8">
                <style>
                    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 900px; margin: 40px auto; padding: 0 20px; }
                    ...
                    pre { background: #f8f8f8; border: 1px solid #ddd; border-left: 3px solid #3498db; padding: 12px; overflow-x: auto; border-radius: 4px; }
